...
public class SettingWindow : Mod
{
    ...
    public override void DoSettingsWindowContents(Rect inRect)
    {
        ...
        listing_Standard.GapLine(15f);
        listing_Standard.Label($"{"SrSurfaceMultiplier".Translate()}: {settingModel.surfaceMultiplier}", -1f,
        ...
        listing_Standard.GapLine(15f);
        listing_Standard.Label($"{"SrUndergroundMultiplier".Translate()}: {settingModel.undergroundMultiplier}", -1f,
        ...
        listing_Standard.GapLine(15f);
        listing_Standard.Label($"{"SrOutpostMapSize".Translate()}: {settingModel.outpostMapSize}", -1f,
        ...
        listing_Standard.GapLine(15f);
        listing_Standard.Label($"{"SrMaxOutpostCount".Translate()}: {settingModel.maxOutpostCount}", -1f,
        ...
        {
            listing_Standard.GapLine(15f);
            listing_Standard.Label($"qMin: {settingModel.qMin}", -1f, "qMin");
            settingModel.qMin = listing_Standard.Slider(settingModel.qMin, 0.1f, 10f);
            listing_Standard.GapLine(15f);
            listing_Standard.Label($"qMax: {settingModel.qMax}", -1f, "qMax");
